...
/**
 * Retained from the fixture-only slice: deterministic scout/judge doubles used
 * by replay tests. Live adapters live in `providers.ts`.
 */
/** Runtime guard against registering an ad-hoc adapter outside `providers.ts`. */
